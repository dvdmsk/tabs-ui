...
import styles from "./AuswahllistenIco.module.scss";

const AuswahllistenIco = () => {
  return (
    <div className={styles.AuswahllistenIco}>
      <svg
      ...
      >
        <g clipPath="url(#clip0_1_297)">
          <path
            d="M16.0002 2.66687H4.66687V4.0002H16.0002V2.66687Z"
            fill="#7F858D"
          />
          <path
            d="M16.0002 7.33313H4.66687V8.66647H16.0002V7.33313Z"
            fill="#7F858D"
          />
...
export default AuswahllistenIco;
